    ...
    return (
        <div className="text-center">
            <div role="status" className="absolute -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2">
                <p className="text-3xl italic pb-2 text-fuchsia-950">{t("pages.orgInvitation.loading")}</p>
                <svg aria-hidden="true" className="inline w-36 h-36 text-gray-200 animate-spin fill-fuchsia-800" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
